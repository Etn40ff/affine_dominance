...
We verify the \lcnamecref{finite P point bip} type-by-type using the marked surfaces model and computations.
We assume the most basic facts about the marked surfaces model \cite{cats1,cats2}.
...
Then up to switching the orientation of the plane, $T$ is as shown in \cref{T fig}.
\begin{figure}
NEED THIS
%\scalebox{1}{\includegraphics{case1.ps}}
