...
\begin{document}
  ...
  \begin{proof}
    ...
    \[ \widetilde B^t = \mu_\bfk \widetilde B^+ = \widetilde E^{t_N}_{k_N,-\varepsilon^{t_N}_{k_N}}\cdots E^{t_1}_{k_1,-\varepsilon^{t_1}_{k_1}} \widetilde B^+ F^{t_1}_{k_1,-\varepsilon^{t_1}_{k_1}}\cdots F^{t_N}_{k_N,-\varepsilon^{t_N}_{k_N}}, \]
