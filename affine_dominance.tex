...
\begin{document}
  ...
  For $\tilde\lambda\in\RR^m$ and $\bfk=(k_N,\ldots,k_1)$, define $S_{\bfk,\tilde\lambda}=\left\{\left(\eta^{\widetilde{B}}_\bfk\right)^{-1}\big(\eta^{\widetilde B^{t_+}}_\bfk(\tilde\lambda)+\widetilde{B}^{t_+}\alpha\big):\alpha\in\RR^n_{\ge0}\right\}$.
  ...
  \begin{definition}
    ...
    Write $\cP_\ZZ(\tilde\lambda):=\cP(\tilde\lambda)\cap \widetilde B^+ \cdot \ZZ_{\ge0}^n$. 
  \end{definition}
  ...
  \begin{definition}
    Consider real $\tilde \lambda$, say $\tilde \lambda\in \widetilde K_t:= K_t\times \RR^{m-n}$.
    Let $t$ be connected to $t_+$ by a sequence of edges labeled by $\bfk^+=(k_N,\ldots k_1)$. 
    Define the \emph{green cone} $S_\lambda^+:=S_{\bfk^+,\tilde\lambda}\cap\widetilde K_t$.
    Similarly, let $\bfk^-=(n,\ldots,1,k_N,\ldots,k_1)$ and define the \emph{red cone} $S_\lambda^-:=S_{\bfk^-,\tilde\lambda}\cap\widetilde K_t$.
  \end{definition}
