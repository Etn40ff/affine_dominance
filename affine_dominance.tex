...
\begin{document}
  ...
  \begin{proof}
    ...
    First observe that $\eta^{\widetilde B^{t_+}}_{\bfk^+}$ acts on $\widetilde G^t(\RR_{\ge0}^n\times \RR^{m-n})$ via $\widetilde E^{t_N}_{k_N,-\varepsilon_N} \cdots \widetilde E^{t_1}_{k_1,-\varepsilon_1}$, where $\varepsilon_i$ is the sign of the $i$-th row of $\tilde G^{t_{N+2-i}}$. 
