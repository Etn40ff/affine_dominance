...
\section{Rank 2 Again}
  ...
  \begin{lemma}
    The corresponding starting inequalities pointed at $\mu_t(\lambda)$ are given by
    \begin{align*}
      &\left\{\substack{\langle(0,0,u^+_{2k+1},-u^+_{2k}),\mu\rangle\ge0\\ \langle(0,0,u^-_{2k},-u^-_{2k-1}),\mu\rangle\ge0\\ \langle(-1,0,-bu^-_{2k},bu^-_{2k-1}),\mu\rangle=u^+_{2k-1}\lambda_1+u^+_{2k}\lambda_2\\ \langle(0,-1,cu^+_{2k+1},-cu^+_{2k}),\mu\rangle=-u^-_{2k}\lambda_1-u^-_{2k+1}\lambda_2}\right\} & & \left\{\substack{\langle(0,0,u^+_{2k+1},-u^+_{2k}),\mu\rangle\ge0\\ \langle(0,0,u^-_{2k+2},-u^-_{2k+1}),\mu\rangle\ge0}\right\}\\
      &\left\{\substack{\langle(0,0,-1,0),\mu\rangle\ge -\lambda_1\\ \langle(0,0,0,1),\mu\rangle\ge0}\right\} & & \left\{\substack{\langle(0,0,-1,0),\mu\rangle\ge -\lambda_1\\ \langle(0,0,0,-1),\mu\rangle\ge -c\lambda_1-\lambda_2}\right\}\\
      &\left\{\substack{\langle(0,0,u^+_{2k-1},-u^+_{2k}),\mu\rangle\ge -u^+_{2k+1}\lambda_1-u^+_{2k}\lambda_2\\ \langle(0,0,u^-_{2k},-u^-_{2k+1}),\mu\rangle\ge -u^-_{2k+2}\lambda_1-u^-_{2k+1}\lambda_2}\right\} & & \left\{\substack{\langle(0,0,u^+_{2k+1},-u^+_{2k+2}),\mu\rangle\ge u^+_{2k+3}\lambda_1-u^+_{2k+2}\lambda_2\\ \langle(0,0,u^-_{2k},-u^-_{2k+1}),\mu\rangle\ge -u^-_{2k+2}\lambda_1-u^-_{2k+1}\lambda_2}\right\}
    \end{align*}
  \end{lemma}
  \begin{proof}
    Explicit case by case check that the given normal vectors provide the rows of a left preuso-inverse for the mutated exchange matrices from Lemma~\ref{lem:rank 2 exchange matrices}.
  \end{proof}
