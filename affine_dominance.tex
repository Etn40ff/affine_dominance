...
\section{Rank 2 Again}
  ...
  \begin{lemma}
    ...
    \begin{align*}
      &\left\{\substack{\langle(0,0,u^+_{2k+1},-u^+_{2k}),\mu\rangle\ge0\\ \langle(0,0,u^-_{2k},-u^-_{2k-1}),\mu\rangle\ge0}\right\} & & \left\{\substack{\langle(0,0,u^+_{2k+1},-u^+_{2k}),\mu\rangle\ge0\\ \langle(0,0,u^-_{2k+2},-u^-_{2k+1}),\mu\rangle\ge0}\right\}\\
  ...
  \end{lemma}
  \begin{proof}
    Explicit case by case check that the normal vectors provide the rows of a left preuso-inverse for the mutated exchange matrices from Lemma~\ref{lem:rank 2 exchange matrices}.
  \end{proof}
