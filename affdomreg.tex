...
In Section~\ref{aff sec}, we prove the same fact for $B$ of affine type, $\tB$ with linearly independent columns, and $\lambda$ in the $\g$-vector fan (Theorem~\ref{affine P point indep}). 
...
\sayS{Added this sentence. Should we say geometric and/or linear algebraic instead of combinatorial? \rd{``elementary proof''?} \rs{I am not sure about elementary: we have a theorem, he has a lemma...}} 
