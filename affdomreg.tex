...
\sayN{Have we explained ``associated seed''?  (I guess, sort of, above, but only for finite type.)  We mean the seed at the end of the green sequence in Proposition~\ref{sort green}, but should we say so? \rs{I tried rephrasing}}
\end{proposition}
\begin{proof}
...
\sayD{Should we introduce the Tits cone at the start of this section?  \rn{No objection.} \rs{Maybe not: we give lots of baground for granted and I do not expect that anyone can read up to here without knowing what the Tits cone is}} 
...
\sayD{\color{orange}This argument is remarkably similar to the proof of Proposition 2.28 so I thought it could make sense to combine them, but it isn't clear if there is any way for this to actually work with the structure of the paper. \rs{I am ok either way; probably it is more efficient to leave things as is}.  \rn{I vote efficiency.}}  
\end{proposition}
\begin{proof}  
...
\sayD{The notation of $\gamma$ and $\xi$ was introduced around 7 pages back, it seems like we should recall their meaning before using them again.\rs{added "$\g$-vector" to help with this}}
