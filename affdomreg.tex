...
\sayN{Say more?  Say differently?\rs{How about this`?}}
For both these applications the relevant notion is is that of integral dominance regions i.e. the intersection of dominance regions with the integral lattice spanned by the columns of $\tB$.
...
If two cluster variables $x_{qr}$ and $x_{q'r'}$ are exchangeable, then without loss of generality, $q<q'$, \sayN{changed $q<q'<r$ to $q<q'$.\rs{OK}} 
$q<r<r'$, and $q'\le r+1$.
...
\sayN{There was a problem here.  We were being too flippant about restricting from the ray to the line segment, but a little ``salience'' makes it correct.\rs{OK}}
