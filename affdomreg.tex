...
\sayS{This proof was not correct as it was not properly taking care of the permutation, please check my fix.}
...
\sayS{Was $\eta_{\kk^{-1}}^{B_r^T}\set{\eta_\kk^{B_0^T}(\lambda')+B_r\alpha:\alpha\ge0}\subseteq\eta_{k_1}^{B_1^T}\set{\lambda'+B_1C_t^{B_1;t_1}\alpha:\alpha\ge0}$}
