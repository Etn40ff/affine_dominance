...
characterizes all pointed bases of the upper cluster algebra in terms of this order.
...
(
\sayS{\color{orange}In~\cite{RSDom} we were agnostic about about this}
...
As in this paper we seldom use mutation maps without a transpose, we could have opted to drop the superscript $^T$ in our notation.
We refrained from dropping it because we will need to discuss and adapt parts of some proofs already written elsewhere with our current notation.
\sayS{Added this sentence to justify our three levels notation.  \rn{Good idea.  I revised slightly.}}
