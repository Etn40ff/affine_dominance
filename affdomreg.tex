...
Let $\APT{c}=\APTre{c}\cup\set\delta$. \sayD{The $c$ here is a subscript while it is a superscript in other places, does it make sense to make this uniform and always use subscripts?  \rn{Possibly it makes sense.  But I shudder at altering the notation that we have used in the \{affdenom\} paper, which was so notation-heavy.  I vote for this notation to be ``grandfathered in''.}} 
