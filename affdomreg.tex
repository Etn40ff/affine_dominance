...
if $x$ is a vector whose affine entries are zero, then the affine entries of $\eta^{B^T}_{\widehat\kk}k(x)$ are zero and $\eta^{B^T}_{\widehat\kk}(x)=\eta^{\Comp(B)^T}_\kk(x)$.
