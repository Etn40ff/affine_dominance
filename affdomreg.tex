...
\rs{I am not sure that we are claiming the same thing: they basically say that the set of clusters containig any given $n-1$ cluster variables consists only of two elements while we are saying that any exchangeable pair of cluster variables is withnessed by the same subset of cluster variables. I am still surprised that this result is new but I am voting to leave it as is} }
\begin{proof}
