...
\sayN{Fill in support for Salvatore}
...
(In~\cite{RSDom} and in this paper, we consider \emph{tall} extended exchange matrices rather than \emph{wide} ones.
...
&=(E_{-,k_r}^{B_{r-1}}\lambda)^T\Sigma F_{-,k_r}^{B_{r-1}}\delta^{B_{r-1}}\\
&=\lambda^T(E_{-,k_r}^{B_{r-1}})^T\Sigma F_{-,k_r}^{B_{r-1}}\delta^{B_{r-1}}\\
&=\lambda^T\Sigma F_{-,k_r}^{B_{r-1}}F_{-,k_r}^{B_{r-1}}\delta^{B_{r-1}}=\lambda^T\Sigma\delta^{B_{r-1}}=\br{\lambda,\delta^{B_{r-1}}}=0.
\end{align*}
