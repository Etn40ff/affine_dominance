...
\sayS{@Nathan I changed ``imaginary wall'' to ``boundary of the $\g$-vector fan'' at the end of the abstract; is it OK? \rd{It reads fine to me.}}
\sayS{I changed $\tilde B$ to $\widetilde B$  \rn{After some thought, I'm not wild about this change.  It makes higher lines in the prose (see, for example, the 7th line of the first paragraph) and it makes the tilde too far above the $B$.  But I'll go with whatever the group decides.}\rs{I prefer widetilde for readibility but I agree that it is too high and ruins lines. I tried looking for alternatives but could not locate a good one} \rd{I usually prefer the widetilde but I'm fine either way.}}
