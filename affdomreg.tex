...
\scalebox{1}{\begin{picture}(0,0)(54,-54)
%\put(-25,13){\small$q$}
\put(-47,36){\small$q$}
\put(45,-24){\small$r$}
\put(26,45){\small$q'$}
\put(-48,-44){\small$r'$}
\end{picture}}
\caption{An illustration of the proof of Proposition~\ref{A and q-l}}
\label{tube fig}
\end{figure}
The solid lines in Figure~\ref{tube fig} indicate~$\beta_{qr}$ and~$\beta_{q'r'}$ in the case where $q'<r$.
...
The dashed lines in Figure~\ref{tube fig} indicate $\beta_{qr'}$, $\beta_{q'r}$, $\beta_{q(q'-2)}$, and $\beta_{(r+2)r'}$.
...
The diagonal associated to $\gamma_i$ is contained in a quadrilateral in~$T$, as illustrated in Figure~\ref{tri fig}.   \sayN{Need picture.}
\begin{figure}
%\includegraphics{trifig}
\caption{Another illustration of the proof of Proposition~\ref{A and q-l}}
\label{tri fig}
\end{figure}
