...
\end{lemma}
\begin{proof}
By the definition of a red sequence, the lemma is equivalent to the statement that  $\kk=k_r\cdots k_1$ of indices is a maximal green sequence for $B_0$ if and only if $\kk^{-1}=k_1\cdots k_r$ is a maximal green sequence for~$-B_r$.
...
Then $\tau_c^{i+\ell}\big((\nu_c)^{-1}(x)\big)=\tau_c^i\big((\nu_c)^{-1}(x)\big)+a\delta$ for $i>\max(I_1,\ldots,I_\ell)$ and $\tau_c^{i-\ell}\big((\nu_c)^{-1}(x)\big)=\tau_c^i\big((\nu_c)^{-1}(x)\big)+a\delta$ for $i<\min(I_1,\ldots,I_\ell)$.
