...
In that case, the line segments are parallel to the imaginary ray and have one endpoint at $\lambda$ and the other endpoint on the relative boundary of the imaginary wall.
...
For both of these applications the relevant notion is the integral dominance region: the set of points in $\P_\lambda^\tB$ that are obtained as $\lambda$ plus an \emph{integer}-linear combination of columns of $\tB$.
