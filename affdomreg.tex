...
We see the affine entries of $\eta^{B^T}_\kk(x)$ are zero and that $\bigl(\eta^{B^T}_\kk(x)\bigr)_\na=\eta^{\Comp(B)^T}_k(x_\na)$.
...
if $x$ is a vector whose affine entries are zero, then the affine entries of $\eta^{B^T}_{\widehat\kk}k(x)$ are zero and $\bigl(\eta^{B^T}_{\widehat\kk}(x)\bigr)_\na=\eta^{\Comp(B)^T}_\kk(x_\na)$.
